        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-sm border border-neutral-200 p-6">
            ...
            <p className="text-2xl font-bold text-neutral-900">
              ${displayStats.totalDonated.toLocaleString()}
            </p>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-neutral-200 p-6">
            ...
            <p className="text-2xl font-bold text-neutral-900">{displayStats.causesSupported}</p>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-neutral-200 p-6">
            ...
            <p className="text-2xl font-bold text-neutral-900">{displayStats.impactScore}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-neutral-200 p-6">
            ...
            <div className="space-y-4">
              {displayStats.recentDonations.map((donation) => (
