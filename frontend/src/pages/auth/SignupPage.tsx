...
export function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-slate-50 relative overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-10">
            <div className="hidden lg:flex flex-col justify-center space-y-8">
              <div>
                ...
                <p className="text-lg text-gray-600">
                  Create an account to start organizing or supporting meaningful causes. Connect with communities and make a lasting impact.
                </p>
              </div>
              ...
              <div className="grid gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Collaborate effortlessly</h3>
                    <p className="text-sm text-gray-600">Bring together volunteers, donors, and organizers in one place.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="mt-1 h-2 w-2 rounded-full bg-emerald-500" />
                  <div>
                    <h3 className="font-semibold text-gray-900">Grow your impact</h3>
                    <p className="text-sm text-gray-600">Track donations, manage updates, and share progress in real time.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="mt-1 h-2 w-2 rounded-full bg-emerald-500" />
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Secure authentication, verified organizations, and transparent reporting.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
              ...
              <Button
                ...
                disabled={googleUrlLoading || !!googleUrlError || !googleUrl}
              >
                {googleUrlLoading ? (
                  <div className="flex items-center justify-center gap-2">
              ...
              {/* Error Message for Google URL fetching */}
              {googleUrlError && (
                <p className="text-sm text-red-500 text-center mt-4">
                  Google sign-up isn't available right now. Please use email/password.
                </p>
              )}
