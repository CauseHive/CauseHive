...
# Removed deprecated settings - using ACCOUNT_SIGNUP_FIELDS instead
...
INSTALLED_APPS = [
    ...
    'causes',
    'categories',
<<<<<<< HEAD:causehive_monolith/settings.py
    'testimonials',
    
    # Donation processing service apps
=======

>>>>>>> 7eb695c02e4e74012421654c5943d53b9cb98af9:backend/causehive/settings.py
    'donations',
    'cart',
    'payments',
    'withdrawal_transfer',
